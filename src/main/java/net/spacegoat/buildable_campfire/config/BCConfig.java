...
public class BCConfig implements ConfigData {
    ...
    public static class Gameplay {
        ...
        @Comment("Players can turn Logs into 2 Campfire Logs by right-clicking onto them with an Axe while crouching at the cost of some energy.")
        public boolean logChopping = true;
        @ConfigEntry.Gui.CollapsibleObject
        public LogChoppingConfig logChoppingConfig = new LogChoppingConfig();
        public static class LogChoppingConfig {
            public int droppedCampfireLogs = 2;
            public int energyLoss = 8;
            public int toolDamage = 1;
        }
        @Comment("Players can turn Campfire Logs into 4 Sticks by right-clicking onto them with an Axe while crouching at the cost of some energy.")
        public boolean campfireLogChopping = true;
        @ConfigEntry.Gui.CollapsibleObject
        public CampfireLogChoppingConfig campfireLogChoppingConfig = new CampfireLogChoppingConfig();
        public static class CampfireLogChoppingConfig {
            public int droppedSticks = 4;
            public int energyLoss = 4;
            public int toolDamage = 1;
        }
        @ConfigEntry.Gui.RequiresRestart
        @Comment("Disables Campfire and Soul Campfire Blocks' recipes, so players will need to build them instead.")
        public boolean disableCampfireBlockRecipes = true;
        @ConfigEntry.Gui.RequiresRestart
        @Comment("Disables modded campfires' recipes, so players will need to build them instead.")
        public boolean disableModdedCampfireBlockRecipes = true;
        @Comment("Campfire Logs Block will drop its item form depending on how much log it has.")
        public boolean campfireLogDrops = true;
    ...
    public static class CampfireBlockConfig {
        ...
        public boolean buildableCampfire = true;
    ...
    public static class SoulCampfireBlockConfig {
        ...
        public boolean buildableSoulCampfire = true;
    ...
    public static class ModdedCampfiresConfig {
        ...
        public static class BYGCampfiresConfig {
            ...
            public static class BoricCampfireBlockConfig {
                ...
                public boolean buildableBoricCampfire = true;
            ...
            public static class CrypticCampfireBlockConfig {
                @Comment("Oh The Biomes You'll Go - Green Smoked Campfire")
                public boolean buildableCrypticCampfire = true;
                @Comment("Should your Boric Campfire be lit when you build it?")
